...
class TimerClassServiceActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        super.onResume()
        if (DeviceManager.isServiceRunning(this, Constants.TAG_TIMER_CLASS_SERVICE)) {
    ...
    private fun startService() {
        ...
        startService(Intent(baseContext, TimerClassService::class.java))
    }
}

...
class LongRunningServiceActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        super.onResume()
        if (DeviceManager.isServiceRunning(this, Constants.TAG_LONG_RUNNING_SERVICE)) {
    ...
    private fun startService() {
        ...
        startService(Intent(baseContext, LongRunningService::class.java))
    }
}
